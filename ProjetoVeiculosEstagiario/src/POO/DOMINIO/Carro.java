...
public class Carro extends BaseVeiculosTerrestres{
    ...
    public Carro(int codigo, String cidadeUF, String estadoUF, String nome, String modelo, String cor, int anoModelo,
            ...
            String placa, String codigoRenavam, String tipoCambio, int eixos, String categoria, int portas) {
